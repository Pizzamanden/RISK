...
public class HumanRevamp extends Player{
     ...
     */
    public HumanRevamp(int assignedNumber) {
    ...
    public Move attack(Board board){
        while(true){
            ...
            Land targetLand = Land.getLandFromListByName(fromLandNeighbours, destLandName);
            if(targetLand == null){
            ...
            // Now we find hostile neighbours
            ArrayList<Land> attackTargets = targetLand.getHostileNeighbours();
